...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.scrollChanges = (0, _jquery2.default)('.scroll-changes');
        this.headerTriggerElement = (0, _jquery2.default)(".large-hero__text-content");
        ...
        value: function createHeaderWaypoint() {
            ...
            new Waypoint({
                ...
                handler: function handler(direction) {
                    if (direction == 'down') {
                        that.scrollChanges.addClass("scroll-changes--is-visible");
                    } else {
                        that.scrollChanges.removeClass("scroll-changes--is-visible");
                    }
                }
            });
        }
...
new _RevealOnScroll2.default((0, _jquery2.default)('.icon'), '85%');
new _RevealOnScroll2.default((0, _jquery2.default)('.btn'), '60%');
